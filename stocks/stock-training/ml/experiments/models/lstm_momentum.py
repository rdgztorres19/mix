"""
lstm_momentum.py — LSTM model for momentum sequence prediction.

Input: (batch, seq_len, n_features) — sequence of candle features
Output: (batch, 1) — probability of profitable trade
"""
