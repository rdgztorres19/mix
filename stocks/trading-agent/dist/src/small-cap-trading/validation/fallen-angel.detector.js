...
exports.FallenAngelDetector = void 0;
class FallenAngelDetector {
    constructor() {
        this.MIN_CANDLES = 6;
    }
    detect(candles, preMarketHigh) {
        const empty = { detected: false, name: 'FALLEN_ANGEL', anchor_points: [], description: '' };
...
exports.FallenAngelDetector = FallenAngelDetector;
