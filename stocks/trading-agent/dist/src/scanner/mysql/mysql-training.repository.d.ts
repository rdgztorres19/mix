export declare class MysqlTrainingRepository {
    ...
    ensureStockProfileTable(): Promise<void>;
    countStockProfileRows(): Promise<number>;
    loadAllStockProfiles(): Promise<Map<string, {
        sharesOutstanding: number | null;
        marketCap: number | null;
    }>>;
    bulkReplaceStockProfiles(rows: Array<{
        symbol: string;
        sharesOutstanding: number | null;
        marketCap: number | null;
    }>): Promise<void>;
    upsertStockProfile(symbol: string, sharesOutstanding: number | null, marketCap: number | null): Promise<void>;
}
