...
export declare class PredictorController {
    ...
    backtestStream(ticker: string, date: string, fromTime?: string, toTime?: string, thresholdStr?: string, investmentStr?: string, tpPctStr?: string, slPctStr?: string, lookAheadStr?: string): Observable<MessageEvent>;
    backtestStreamDay(date: string, symbolsParam?: string, fromTime?: string, toTime?: string, thresholdStr?: string, investmentStr?: string, tpPctStr?: string, slPctStr?: string, lookAheadStr?: string): Observable<MessageEvent>;
    backtest(body: {
        ticker: string;
        date: string;
        fromTime?: string;
