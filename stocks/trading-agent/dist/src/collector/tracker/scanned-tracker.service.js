...
var ScannedTrackerService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ScannedTrackerService = void 0;
...
let ScannedTrackerService = ScannedTrackerService_1 = class ScannedTrackerService {
    constructor(mysqlRepo) {
        this.mysqlRepo = mysqlRepo;
        this.logger = new common_1.Logger(ScannedTrackerService_1.name);
    ...
    async fetchNewsData(data) {
        try {
            let headlines = await (0, news_tool_1.fetchYahooNews)(data.symbol);
            if (!headlines.length) {
                headlines = await (0, news_tool_1.fetchFinvizNews)(data.symbol);
            }
            const { strength, catalyst_type } = await (0, news_tool_1.scoreHeadlines)(headlines);
...
exports.ScannedTrackerService = ScannedTrackerService;
exports.ScannedTrackerService = ScannedTrackerService = ScannedTrackerService_1 = __decorate([
