...
const fundamental_cache_1 = require("../training/fundamental-cache");
...
let CollectorService = CollectorService_1 = class CollectorService {
    constructor(moduleRef, mysqlRepo, alpacaDataSource, scannerService, momoStream, gateway, topGainersSource, autoTrader) {
    ...
    async _syncSymbolDateCore(symbol, dateStr) {
        ...
        const preMarketHigh = preMarketCandles.length
            ...
            : null;
        const fundamentals = await (0, fundamental_cache_1.getFundamentals)(symbol);
        const metadata = {
            priorClose,
...
exports.CollectorService = CollectorService = CollectorService_1 = __decorate([
    ...
    __param(7, (0, common_1.Inject)(auto_trader_service_1.AutoTraderService)),
