...
export declare class CollectorService implements OnModuleInit {
    ...
    constructor(moduleRef: ModuleRef, mysqlRepo: MysqlTrainingRepository, alpacaDataSource: AlpacaDataSource, scannerService: ScannerService, momoStream: MomoStreamService, gateway: CollectorGateway, topGainersSource: TopGainersSourceService, scannedTracker: ScannedTrackerService, fundamentalCache: FundamentalCacheService, autoTrader?: AutoTraderService);
