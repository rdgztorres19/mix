...
exports.createScannerTool = createScannerTool;
exports.getSession = getSession;
exports.formatStockSnapshotForLLM = formatStockSnapshotForLLM;
...
function createScannerTool(scannerService, cutoffMs, timeframe = '5m') {
    return (0, tools_1.tool)(async ({ ticker }) => {
        ...
        name: 'get_stock_data',
        description: 'Fetches real-time stock data from momoscreener.com for a given ticker. ' +
...
function getSession(etTime) {
    ...
    if (totalMinutes < 10 * 60 + 30)
        return 'THE_OPEN (9:30-10:30am)';
    if (totalMinutes < 12 * 60)
        return 'LATE_MORNING (10:30am-12pm)';
    if (totalMinutes < 15 * 60)
        return 'MIDDAY (12pm-3pm)';
    if (totalMinutes < 16 * 60)
        return 'THE_CLOSE (3pm-4pm)';
    return 'AFTER_HOURS';
}
function formatStockSnapshotForLLM(snap, ticker, timeframe, cutoffMs) {
...
//# sourceMappingURL=scanner.tool.js.map