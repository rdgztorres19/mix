...
Object.defineProperty(exports, "OrbDetector", {
    enumerable: true,
    get: function() {
        return OrbDetector;
    }
});
let OrbDetector = class OrbDetector {
    detect(candles, atr) {
        const empty = {
            detected: false,
            name: 'ORB',
    ...
    /** Find the first candle that falls in the 9:30–9:35 ET window. */ findOpeningCandle(candles) {
