...
Object.defineProperty(exports, "HardStopsValidator", {
    enumerable: true,
    get: function() {
        return HardStopsValidator;
    }
});
let HardStopsValidator = class HardStopsValidator {
    validate(ctx) {
        const failures = [];
    ...
    checkSession(ctx) {
        if (ctx.session === 'AFTER_HOURS' || ctx.session.startsWith('AFTER_HOURS')) return 'After hours: no live trading';
        return null;
    }
    checkPriceMin(ctx) {
