...
skills = [
    AgentSkill(
        id='generate_title',
        name='Generate Title',
        description='Generates a compelling title based on content or topic',
        tags=['title', 'writing'],
        examples=[
            'Can you generate a title for this article?',
            'What would be a good title for this content?',
            'Help me create a catchy title',
        ],
    ),
]
...
agent_card = AgentCard(
    ...
    'I can help you generate compelling titles for your articles, blog posts, and content.',
