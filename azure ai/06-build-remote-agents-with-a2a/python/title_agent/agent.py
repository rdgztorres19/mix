...
class TitleAgent:
    ...
    async def create_agent(self) -> Agent:
        ...
        self.agent = self.client.create_agent(
            ...
            name='foundry-title-agent',
            instructions="""
            You are a helpful writing assistant.
            Based on the provided content or topic, generate a compelling and concise title.
            The title should be catchy, informative, and suitable for a blog post or article.
            Keep it under 60 characters when possible for optimal SEO.
            """,
        )
