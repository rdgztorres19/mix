...
print("🎯 Multi-Agent Support Ticket Triage System")
print("=" * 50)
...
with agents_client:
    ...
    print("🏗️ Creando agentes especializados...")
...
"""
    ...
    print("✅ Team Assignment Agent creado")
...
"""
    ...
    print("✅ Effort Estimation Agent creado")
    ...
    print("🔧 Connected Agent Tools configuradas")
...
"""
    ...
    print("✅ Triage Coordinator Agent creado")
    print()

    # Use the agents to triage a support issue
    print("🎫 Sistema de Triage de Tickets Listo")
    print("=" * 50)
    print("Ejemplos de tickets que puedes probar:")
    print("• Users can't reset their password from the mobile app")
    print("• Investigate occasional 502 errors from the search endpoint")
    print("• Update company logo on marketing website")
    print("• Database backup job is failing every night")
    print()
    ...
    prompt = input("🎯 What's the support problem you need to resolve?: ")
    ...
    print("📋 Los agentes están colaborando para hacer triage del ticket...")
    ...
    print("🗑️ Deleted priority agent.")
    agents_client.delete_agent(team_agent.id)
    print("🗑️ Deleted team agent.")
    agents_client.delete_agent(effort_agent.id)
    print("🗑️ Deleted effort agent.")
    print()
    print("✅ Multi-Agent Triage System completado!")