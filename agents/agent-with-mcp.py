...
print("Azure AI Agent - Technical Support Tool")
print("======================================")
...
with (
    ...
    mcp_tool = MCPTool(
        server_label="simple_mcp_server",
        server_url="https://learn.microsoft.com/api/mcp",  # ← Simple MCP Server local
        require_approval="never",  # o "always"
    )
